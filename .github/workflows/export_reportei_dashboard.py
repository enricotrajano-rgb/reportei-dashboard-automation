...
from export_reportei_csv import (
    NETWORK_ORDER,
    NETWORKS,
    filter_projects,
    format_number,
    get_client,
    get_integrations_by_slug,
    get_metric_definitions_map,
    list_projects,
    normalize_date,
    prepare_metric_definition_for_request,
)
...
DEFAULT_START_DATE = "01/07/2026"
DEFAULT_END_DATE = "06/07/2026"   
...
def build_rows(
    ...
    for current_step, work_item in enumerate(work_items, start=1):
        ...
        integration = work_item["integration"]
        ...
        if network_slug == "facebook":
            period_values = fetch_period_daily_values(
                client,
                integration["id"],
                metric_map,
                start_iso,
            ...
            if network_slug == "facebook" and missing_field_names:
                if skip_daily_only:
                    ...
                    if daily_fields_to_fetch:
                        fields.update(fetch_missing_daily_fields(
                            client,
                            integration["id"],
                            metric_map,
                            network_slug,
                ...
                if skip_daily_only:
                    ...
                    fields.update(fetch_daily_network_fields(
                        client,
                        integration["id"],
                        metric_map,
                        network_slug,
